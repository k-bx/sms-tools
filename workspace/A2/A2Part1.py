...
if __name__ == '__main__':
    A = 1.0
    print("arccos(res / A) of expected results:")
    print(np.arccos(np.array([ 0.54030231, -0.63332387, -0.93171798,  0.05749049,  0.96724906]) / A))
    print("arccos(res / A) of my results:")
    print(np.arccos(genSine(A=1.0, f=10.0, phi=1.0, fs=50.0, t=0.1) / A))
    print("expected results:")
    print(np.array([ 0.54030231, -0.63332387, -0.93171798,  0.05749049,  0.96724906]))
    print("my results:")
