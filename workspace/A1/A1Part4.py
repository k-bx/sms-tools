...
from utilFunctions import wavread, wavwrite, wavplay
...
def downsampleAudio(inputFile, M):
    ...
    x_ = hopSamples(x, M)
    print x_[:10]
    wavwrite(x_, int(fs / M), inputFile[:-4] + "_downsampled.wav")

if __name__ == '__main__':
    downsampleAudio("../../sounds/vibraphone-C6.wav", 16)
    wavplay("../../sounds/vibraphone-C6.wav")
    wavplay("../../sounds/vibraphone-C6_downsampled.wav")
